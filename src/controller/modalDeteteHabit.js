...
function addOnClickEvents() {
    ...
    closeModalButton1.addEventListener("click", function(){closeModal('.modal_habits--delete')})

    let closeModalButton2 = document.querySelector("#cancel")
    closeModalButton2.addEventListener("click", function(){closeModal('.modal_habits--delete')})
