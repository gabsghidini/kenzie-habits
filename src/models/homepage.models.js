class Homepage { 
    ...
    getCardHabitsTitle () {
        ...
        header.append(statusHeader, statusTitle, statusDescription, statusCategory, statusEdit)
    ...
    getCardHabitsDate () {
        ...
        data.append(dataInput, dataTitle, dataDescription, dataCategory, dataEdit)
